...
namespace QLPG_a.Controllers
{
    public class GoiTapController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaGoiTap,TenGoi,ThoiHan,Gia,MoTa")] Subcription sub)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MaGoiTap,TenGoi,ThoiHan,Gia,MoTa")] Subcription sub)
        {
